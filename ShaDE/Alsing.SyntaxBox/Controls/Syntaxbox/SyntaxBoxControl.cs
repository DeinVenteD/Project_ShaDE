...
namespace Alsing.Windows.Forms
{
    ...
    public class SyntaxBoxControl : SplitViewParentControl
    {
        ...
        private Color _BracketBackColor = Color.FromArgb(30, 30, 30);
        private Color _BracketBorderColor = Color.FromArgb(30, 30, 30);
        ...
        private Color _GutterMarginBorderColor = Color.FromArgb(30, 30, 30);
        private Color _GutterMarginColor = Color.FromArgb(30, 30, 30);
        ...
        private Color _ScopeBackColor = Color.FromArgb(250,200,100);
        private Color _ScopeIndicatorColor = Color.FromArgb(30, 30, 30);
        ...
        private bool _ShowGutterMargin = false;
        private bool _ShowLineNumbers = true;
        private bool _ShowTabGuides;
        private bool _ShowWhitespace;
        private int _SmoothScrollSpeed = 2;

        private Color _TabGuideColor = Color.Black;
